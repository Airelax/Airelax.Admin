...
namespace Airelax.Admin
{
    ...
    public class IncomeService : IIncomeService
    {
        ...
        ////5.回傳至controller
        public Dictionary<string, decimal> ConvertToDictionary(IncomeInput incomeInput)
        {
            ...
            var dict = group.GroupBy(x => x.date.ToString("yyyy-MM-dd")).ToDictionary(x => x.Key, x => x.Sum(y => y.sum));
            return dict;
        }
    }
}
